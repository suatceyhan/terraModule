module "nsg_rule_vnet2_vnet3_allow_3389" {
  ...
  name                        = var.nsg_rule_name_vnet2_vnet3
  ...
  source_address_prefix       = module.vnet02_subnet0.address_prefixes
  destination_address_prefix  = module.vnet03_subnet0.address_prefixes
...
module "nsg_rule_vnet3_vnet2_allow_3389" {
  source                      = "../../modules/nsg_rule"
  name                        = var.nsg_rule_name_vnet3_vnet2
  ...
  source_port_range           = var.source_port_range
  destination_port_range      = var.destination_port_range_3389
  source_address_prefix       = module.vnet03_subnet0.address_prefixes
  destination_address_prefix  = module.vnet02_subnet0.address_prefixes
  resource_group_name         = module.az104-06-rg1.rg_name
